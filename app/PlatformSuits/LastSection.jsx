...
const LastSection = () => {
    return (
        <div className="relative w-full h-[60vh] bg-black/80 text-white py-28 px-6 overflow-hidden">
            <div
                className="
        ...
        "
            ...
            <div className="relative z-10 max-w-6xl mx-auto text-center">
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-5">
                    ...
                    <button className="px-5 py-3 rounded-lg border border-white/40 hover:border-white text-white transition">
                        Request a Demo
                    </button>
                </div>
            </div>
